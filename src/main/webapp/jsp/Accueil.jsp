                  ...
                  <ul class="dropdown-menu">
                    ...
                    <div class="col-xs-12">                 		
                      ...
                      <label class="label label-default">Recherche par date</label>
                        <div class="input-group">
                          <input type="date" class="form-control" placeholder="date" autocomplete="off" id="date" name="date" >
                          <span class="input-group-btn">
                            <button class="btn btn-default" type="submit">Go!</button>
                          </span>
                        </div>     
        	...
        	<div class="panel panel-black" style="">
                ...
                <div class="panel-body" style="max-height: 10;overflow-y: auto">
                  <div class="col-sm-6 col-md-3">
                    <div class="thumbnail">
                      <a href="">
                      <img src="ressources/img/img1.png" alt="..." class="img-responsive img-rounded" style="width:200px">
                      </a>
                      <div class="caption">
                        <h3>Thumbnail label</h3>
                        <p>...</p>
                        <p><a href="#" class="btn btn-primary btn-block" role="button">Sessions</a></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                      <img src="ressources/img/img2.jpg" alt="...">
                      <div class="caption">
                        <h3>Thumbnail label</h3>
                        <p>...</p>
                        <p><a href="#" class="btn btn-primary btn-block" role="button">Session</a></p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                      <img src="ressources/img/img3.jpg" alt="...">
                      <div class="caption">
                        <h3>Thumbnail label</h3>
                        <p>...</p>
                        <p><a href="#" class="btn btn-primary btn-block" role="button">Session</a></p>

                                ...
                                <div class="caption text-center">
                                    ...
                                    <div class="caption">
                                        <blockquote>
                                            Session from :
                                            <footer>
                                                <c:set var="start" value="${requestScope.session.startDate}"></c:set>
                                                <c:set var="end" value="${requestScope.session.endDate}"></c:set>
                                                <fmt:formatDate type="date" value="${start}" pattern="MM-dd-yyyy"/><strong> to </strong> <fmt:formatDate  type="date" value="${end}" pattern="MM-dd-yyyy"/> <br></br>
                                                <strong> in </strong> ${requestScope.session.location.city}
                                            </footer>
                                        </blockquote>
                                    </div>
